...
import { Bullseye, DropdownItem, DropdownList } from "@patternfly/react-core";

import userAvatar from "@app/images/avatar.svg";
import patternflyAvatar from "@app/images/patternfly_avatar.jpg";
...
export const Home: React.FC = () => {
  ...
  const horizontalLogo = <Bullseye>Logo</Bullseye>;
